...
(function(){
    emailjs.init("OGgaXuHm2qQxpuy6D"); // Replace "YOUR_USER_ID" with your actual EmailJS User ID
})();
...
document.getElementById('form').addEventListener('submit', function(event) {
    ...
    const serviceID = 'service_iybo07k'; // Replace 'YOUR_SERVICE_ID' with your actual EmailJS service ID
    const templateID = 'template_ziqf89b'; // Replace 'YOUR_TEMPLATE_ID' with your actual EmailJS template ID
